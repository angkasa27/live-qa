...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-3 font-bold data-[variant=label]:text-md data-[variant=legend]:text-base",
        className
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 text-md font-bold group-data-[disabled=true]/field:opacity-50 [&_svg:not([class*='size-'])]:size-[15px] [&_svg]:shrink-0 [&_svg]:stroke-faint",
        className
      )}
      {...props}
    />
