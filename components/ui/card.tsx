...
/**
 * Generated by `shadcn add card`, then edited to the house rules in docs/DESIGN.md.
 * Regenerating this file DISCARDS those edits; re-apply them from that document.
 *
 *  - `shadow-xs ring-1 ring-foreground/10` became `border border-border`. The design is
 *    flat and border-based; there is not a single shadow anywhere else in the product.
 *  - Default spacing tightened from 6 to 4 (24px to 16px). These cards are read on a
 *    phone held in one hand, where 24px of padding costs a line of the question.
 */
