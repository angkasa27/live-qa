  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-4 py-20 text-center sm:px-6">
      ...
      <div className="mt-7 flex flex-col gap-3 sm:flex-row">
        <button
          onClick={reset}
          className="flex min-h-[3rem] items-center justify-center rounded-xl bg-accent px-6 font-semibold text-accent-fg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
          Coba lagi
        </button>
        <Link
          href="/"
          className="flex min-h-[3rem] items-center justify-center rounded-xl border border-border px-6 font-medium transition-colors hover:border-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
          Semua majelis
        </Link>
      </div>
